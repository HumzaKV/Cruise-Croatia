...
function availability_table_show_more_fn() {
 if( have_rows('availability_table', $_POST['post_id']) ):
    ...
    while( have_rows('availability_table',$_POST['post_id']) ) : the_row();
        ...
        ?>
        <div class="accordion-set"> <!-- accordian set -->
        ...
        </div> <!-- end accordian set -->

        <div class="accordion-body"> <!-- accordian body -->
...
die();
        ...
        // add action for logged in users
    add_action('wp_ajax_travelblog', 'travelblog_show_more_fn');
    // add action for non logged in users
    add_action('wp_ajax_nopriv_travelblog', 'travelblog_show_more_fn');

    function travelblog_show_more_fn() {
        $row = $_POST['row'] + 1;
                $issues_per_page = $_POST['row'] + 6; // How many rows to display on each page
        ...
        // No value.
                    ...
                    echo 'Sorry! No details were found.<br>';
