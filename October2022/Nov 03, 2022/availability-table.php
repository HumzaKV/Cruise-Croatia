<section class="full-section accordion-sec">
    <div class="container">
        <h2>Availability & Fares</h2>
        <div class="table-wrapper">
            <div class="table-head">
                <div class="head-col">Departure Date</div>
                <div class="head-col">Ship</div>
            ...
            <div class="table-body">
                ...
                $issues_per_page = 10; // How many rows to display on each page
                $total = count( $issues );
        ...
        // No value.
            ...
            <a id="availability_table_show_more_link" <?php 
            if ($total < $issues_per_page || $issues_per_page == $total) {
...
function jscode_avaibility() {
    ...
    <script>
        ...
        // }
        $(document).on('click', '.booking-btn a', function(){
        ...
        $('#availability_table_show_more_link').click(function(){
