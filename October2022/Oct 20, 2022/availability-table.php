...
<?php
    ...
    <script>
                ...
                function availability_table_show_more() {
                    ...
                    // make ajax request
        jQuery.ajax({
                url: availability_table_ajax_url.ajax_url,
                type : "post",
                dataType : "json",
                data: {
                                    // this is the AJAX action we set up in PHP
                                    'action': 'availability_table_show_more',
                                    'post_id': availability_table_field_post_id,
                },
                success: function(json) {
                                    jQuery('.table-body').append(json['content']);
                                    // update offset
                                    availability_table_field_offset = json['offset'];
