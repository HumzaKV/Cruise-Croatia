...
add_action('wp_ajax_availability_table_data', 'availability_table_data_fn');
    // add action for non logged in users
add_action('wp_ajax_nopriv_availability_table_data', 'availability_table_data_fn');

function availability_table_data_fn() {
    ?> 
    <div class="ajax-data">
        <?php
        if( have_rows('availability_table', $_POST['post_id']) ):
            ...
            while( have_rows('availability_table',$_POST['post_id']) ) : the_row();
                ...
                <div class="accordion-set">
                    ...
                    <div class="col ac-ship"><?php echo get_sub_field('ship'); ?></div>
                    <input type="hidden" value="<?php echo get_sub_field('ship'); ?>" class="ship<?php echo $n ?>">
